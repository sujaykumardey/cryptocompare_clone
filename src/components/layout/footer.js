...
export default class Footer extends Component {
  render() {
    return (
      <>
        <footer
          className="footer ng-scope"
          ng-controller="ContactUsFooterCtrl"
        >
      ...
      <div className="nav-panel">
                ...
                <li role="presentation">
                    <a href="#1" ng-click="switchLights()" className="ng-binding">
  ...
  <div className="col-md-4 col-sm-12 col-xs-12" style={{marginTop: "0px"}}>
